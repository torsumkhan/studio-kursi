...
const navCartButton = document.querySelector(".nav-cart-btn");
...
class UI {
  ...
  addCartItem(item) {
    ...
    <div class="quantity">
      <i class="fa-solid fa-angle-up" buttons data-id=${item.id}></i>
      <p class="item-amount">${item.amount}</p>
      <i class="fa-solid fa-angle-down" buttons data-id=${item.id}></i>
    </div>`;
  ...
  setupApp() {
    ...
    navCartButton.addEventListener("click", this.showcart);
